      ...
      <div className="mx-auto max-w-7xl px-4 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
        <div>
          ...
          >
            ...
            />
            <button className="rounded-md bg-white text-black px-3 py-2 text-sm font-medium">
              Join
            </button>
          </form>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <div className="size-24 bg-white rounded-md grid place-items-center text-black text-xs">
              <img src="/images/qr.jpg" alt="QR code" className="w-full h-full object-contain rounded-md" />
            </div>
